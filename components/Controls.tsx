...
const Controls: React.FC<ControlsProps> = ({ 
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
      ...
      {/* Left Area Wrapper: Settings Panel + Exit Button side-by-side */}
      <div className="absolute top-4 left-4 flex items-start gap-2">
        
        {/* Main Configuration Panel */}
        <div className="pointer-events-auto flex flex-col gap-4 bg-slate-900/90 backdrop-blur-md p-4 rounded-lg border border-slate-700 shadow-xl w-72 max-h-[85vh] overflow-y-auto z-20 scrollbar-thin scrollbar-thumb-slate-600">
        ...
        {/* Exit Button - Moved Outside to the Right */}
        {onExit && (
          <button 
            onClick={onExit}
            className="pointer-events-auto bg-red-600/90 hover:bg-red-500 text-white w-10 h-10 flex items-center justify-center rounded-lg shadow-xl border border-red-400/50 transition-all active:scale-95"
            title={language === 'pt' ? 'Sair da Expedição' : 'Exit Expedition'}
          >
